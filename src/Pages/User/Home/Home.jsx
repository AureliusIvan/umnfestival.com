...
import titleConcept from "./../../../Asset/Image/TextImage/content-intro-2.png"
                ...
                <div className={style.ConceptSection}>
                    <div className={style.paperIntro}>
                        ...
                        <div className={style.contentIntro}>
                            ...
                            <p>UMN Festival merupakan kegiatan mahasiswa dibawah naungan BEM UMN, UMN Festival juga
                                merupakan acara tahunan yang diadakan untuk merayakan ulang tahun Universitas Multimedia
                                Nusantara yang bertepatan pada 26 November.</p>
                        </div>
                    ...
                    <div className={style.paperIntro}>
                        ...
                        />
                        <div className={style.contentIntro}>
                            <img className={style.contentTitleImage} src={titleConcept} alt=""/>
                            <p>UMN Festival 2023 mengangkat tema Spartan dengan tujuan untuk Spartans (Panitia) dan
                                Sparta (Peserta) UMN Festival dapat menanamkannilai-nilai yang merepresentasikan
                                kepribadian seorang Spartan, yaitu Curiosity, Generosity, Courage & Resilience dan
                                Willingness.</p>
                        </div>
                    </div>
                ...
                <div>
                    <div className={style.containerVM}>
                        ...
                        <div className={style.contentVM}>
                            <p>Menjadikan UMN Festival 2023 sebagai kegiatan yang dapat menjadi wadah kolaborasi antar
                                UKM dan mahasiswa/mahasiswi serta sebagai sarana mahasiswa/mahasiswi untuk meningkatkan
                                rasa persatuan dan kesatuan dalam rangka perayaan ulang tahun Universitas Multimedia
                                Nusantara.</p>
                        </div>
                    </div>
                    <div className={style.containerVM}>
                        ...
                        <div className={style.contentVM}>
                            <p>1. Membuat kegiatan yang dapat merangkul seluruh mahasiswa/mahasiswi dari semua fakultas
                                yang ada di Universitas Multimedia Nusantara untuk bertumbuh secara bersama-sama.</p>
                            <p>2. Menanamkan nilai positif kepada mahasiswa/mahasiswi serta masyarakat melalui acara UMN
                                Festival 2022.</p>
                            <p>3. Membuat rangkaian kegiatan yang mengangkat tema ulang tahun UMN dengan
                                mengimplementasikan nilai curiosity (rasa ingin tahu), generosity (murah hati), Courage
                                & Resilience (berani & konsisten) serta Willingness (kesediaan) dalam setiap rangkaian
                                kegiatannya, yang dapat dirayakan oleh seluruh mahasiswa/mahasiswi UMN.</p>
                        </div>
                    </div>
                </div>
